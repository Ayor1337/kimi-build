...
//! file logger that writes to `~/.kami/logs/memory.log`.
//!
//! ## When to use
//!
...
//! tail -f ~/.kami/logs/memory.log      # watch in another terminal
//! ```
...
mod inner {
    ...
    ///
    /// Writes to `~/.kami/logs/memory.log`. Filters to `xai_memory=trace`.
