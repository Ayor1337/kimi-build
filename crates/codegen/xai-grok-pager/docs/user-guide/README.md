# Kimi Build User Guide

Learn how to install, configure, and extend Kimi Build, the terminal-based AI coding assistant from SpaceXAI.
...
Customize and extend Kimi Build.
...
Automate, script, and integrate Kimi Build with other systems.

| # | Document | Description |
|---|----------|-------------|
| 14 | [Headless Mode and Scripting](14-headless-mode.md) | `kami -p`, output formats, CI/CD integration, and piping |
