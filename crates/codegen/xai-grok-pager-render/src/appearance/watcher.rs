...
//!
//! In dev mode, watches ~/.kami/pager.toml for changes and hot-reloads.
...
///
/// In dev mode: reads from ~/.kami/pager.toml, watches for changes.
...
impl ConfigWatcher {
    ...
    ///
    /// - In dev mode: reads/creates ~/.kami/pager.toml, watches for changes
